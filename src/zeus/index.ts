...
export type ValueTypes = {
    ["Query"]: AliasType<{
getFile?: [{	fileKey: string | Variable<any, string>},boolean | `@${string}`],
		__typename?: boolean | `@${string}`
}>;
	["Mutation"]: AliasType<{
uploadFile?: [{	fileInput: ValueTypes["FileInput"] | Variable<any, string>},ValueTypes["FileUploadResponse"]],
		__typename?: boolean | `@${string}`
}>;
	["FileInput"]: {
...
export type ResolverInputTypes = {
    ["Query"]: AliasType<{
getFile?: [{	fileKey: string},boolean | `@${string}`],
		__typename?: boolean | `@${string}`
}>;
	["Mutation"]: AliasType<{
uploadFile?: [{	fileInput: ResolverInputTypes["FileInput"]},ResolverInputTypes["FileUploadResponse"]],
		__typename?: boolean | `@${string}`
}>;
	["FileInput"]: {
	filename: string,
...
export type ModelTypes = {
	...
	["Mutation"]: {
		uploadFile: ModelTypes["FileUploadResponse"]
};
	["FileInput"]: {
	filename: string,
	contentType: string
...
export type GraphQLTypes = {
	...
	["Mutation"]: {
	__typename: "Mutation",
	uploadFile: GraphQLTypes["FileUploadResponse"]
};
	["FileInput"]: {
		filename: string,
	contentType: string
